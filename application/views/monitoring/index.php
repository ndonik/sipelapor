    ...
    <div class="container-fluid text-white">
        ...
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url(); ?>bank">Monitoring Data padi</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            ...
                            <form role="form" method="post" action="<?= base_url('monitoring/filter'); ?>">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data_padi as $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('monitoring/detail/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Detail">
                                                                <i class="icon-input green-text"></i>
                                                            </a>&nbsp;

                                                            <a target="_blank" href="<?= base_url('monitoring/export/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Export">
                                                                <i class="icon-book blue-text"></i>
                                                            </a>&nbsp;

                                                            <a target="_blank" href="<?= base_url('monitoring/cetak/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Print">
