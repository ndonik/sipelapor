                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            ...
                            <form role="form" method="post" action="<?= base_url('kategori_palawija/update'); ?>" id="modalform">
                                <div class="card-body p-6 bg-light p-4" data-height="100%">
                                    <input type="hidden" name="id" value="<?= $kategori_palawija->id; ?>" />

                                    <div class="row pb-4">
                                        <label class="col-md-3 col-form-label">Uraian</label>
                                        <div class="col-md-9">
                                            <input class="form-control" type="text" name="uraian" value="<?= $kategori_palawija->uraian; ?>" maxlength="200" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="card-footer white">
                                    <a href="<?= base_url('kategori_palawija'); ?>">
