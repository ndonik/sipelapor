	...
	<div class="container-fluid text-white">
		...
		<div class="row ">
			<ul class="nav responsive-tab">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url(); ?>data_palawija">Data Palawija</a>
				</li>
				<li class="nav-item">
				...
				<div class="col-md-12">
					<div class="card my-3 no-b">
						<div class="card ">
							...
							<form role="form" method="post" action="<?= base_url('data_palawija/update'); ?>" id="modalform">
								<div class="card-body p-6 bg-light p-4" data-height="100%">
									<input type="hidden" name="id" value="<?= $data_palawija->id; ?>">
									...
									<div class="row pb-4">
										...
										<div class="col-md-9">
											<input class="form-control" type="text" name="nomor" maxlength="100" value="<?= $data_palawija->nomor; ?>" required>
										</div>
									</div>
...
<?php
$id_provinsi = $data_palawija->id_provinsi;
$id_kabupaten = $data_palawija->id_kabupaten;
