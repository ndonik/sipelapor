	...
	<div class="container-fluid text-white">
		...
		<div class="row ">
			<ul class="nav responsive-tab">
				...
				<li class="nav-item">
					<a class="nav-link" href="<?= base_url(); ?>bank">Data Palawija</a>
				</li>
			</ul>
		</div>
	</div>
											...
											<tbody>
												...
												foreach ($data_palawija as $value) { ?>
													<tr>
														...
														<td>
															<a href="<?= base_url('detail_palawija/detail/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Detail">
															...
															<?php if ($value['status'] != 'Complete' && $value['status_verifikasi'] != 'Complete') { ?>
																...
																<a href="<?= base_url('data_palawija/edit/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Edit">
																	<i class="icon-edit"></i>
																</a>
																&nbsp

																<a href="<?= base_url('data_palawija/delete/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content b-0">
				...
				<div class="modal-body no-p no-b">
					<form role="form" method="post" action="<?= base_url('data_palawija/add'); ?>" id="modalform">
