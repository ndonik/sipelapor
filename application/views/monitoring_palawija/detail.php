    ...
    <div class="container-fluid text-white">
        ...
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('monitoring/filter/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>">Monitoring Data Palawija</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link">Monitoring Data Detail Palawija</a>
                </li>
            </ul>
        </div>
    </div>
