    ...
    <div class="container-fluid text-white">
        ...
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link">Data Detail Palawija</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container-fluid relative animatedParent animateOnce">
            ...
            <div class="row my-3">
                    ...
                    <div class="card my-3 no-b">
                        <div class="card ">
                            <div class="card-header white">
                                ...
                                <strong> DATA palawija </strong>
                            </div>
                            <form role="form" method="post" action="<?= base_url('data_palawija/filter'); ?>">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control-plaintext" value="<?= $data_palawija->nomor; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control-plaintext" value="<?= wilayah('provinsi', $data_palawija->id_provinsi); ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control-plaintext" value="<?= wilayah('kabupaten', $data_palawija->id_kabupaten); ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input class="form-control-plaintext" value="<?= wilayah('kecamatan', $data_palawija->id_kecamatan); ?>" readonly>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-5">
                                            <?php
                                            $id_bulan = $data_palawija->id_bulan;
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <input class="form-control-plaintext" value="<?= $data_palawija->tahun; ?>" readonly>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php
                                                    if ($data_palawija->status == 'Pending') {
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-9">
                                                    <?php
                                                    if ($data_palawija->status_verifikasi == 'Pending') {
                                                        echo '<span class="badge badge-warning">Tunggu</span>';
                                                    } else if ($data_palawija->status_verifikasi == 'Cancel') {
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            <div class="card-header white">
                                <i class="icon-table blue-text"></i>
                                <strong> TABEL DETAIL DATA PALAWIJA </strong>
                            </div>
                            <div class="card-body p-6 bg-light" data-height="100%">
                                    ...
                                    <table id="customer_data" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        <thead class="thead-light">
                                            <tr>
                                                ...
                                                <th width="10%">Panen Muda</th>
                                                <th width="10%">Panen Untuk Hijauan Pakan Ternak</th>
                                                <th width="10%">Tanam</th>
                                                <th width="10%">Puso/rusak</th>
                                                <th width="10%">Tanaman Akhir Bulan</th>

                                                <?php if ($data_palawija->status != 'Complete') { ?>
                                                    <th width="5%">Aksi</th>
                                                <?php } ?>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $no = 1;
                                            foreach ($detail_palawija as $value) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    $select = array('sawah_panen', 'sawah_panen_muda', 'sawah_panen_ternak', 'sawah_tanam', 'sawah_rusak');
                                                    ...
                                                    $total_sawah = ($value['sawah_panen'] - $value['sawah_panen_muda'] - $value['sawah_panen_ternak']) +  ($value['sawah_tanam'] -  $value['sawah_rusak']);
                                                    ...
                                                    <td <?= $status_sawah; ?>><?= $value['sawah_panen_muda']; ?></td>
                                                    <td <?= $status_sawah; ?>><?= $value['sawah_panen_ternak']; ?></td>
                                                    ...
                                                    <?php if ($data_palawija->status != 'Complete') { ?>
                                                        <td rowspan="2">
                                                            <a href="<?= base_url('detail_palawija/edit/' . encrypt_url($value['id']) . '/' . encrypt_url($id_data_palawija) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Edit">
                                                                <i class="icon-edit"></i>
                                                            </a>
                                                            &nbsp

                                                            <a href="<?= base_url('detail_palawija/delete/' . encrypt_url($value['id']) . '/' . encrypt_url($id_data_palawija) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus">
                                                ...
                                                <tr>
                                                    ...
                                                    <?php
                                                    $select1 = array('bukan_panen', 'bukan_tanam', 'bukan_panen_muda', 'bukan_panen_ternak', 'bukan_rusak');
                                                    ...
                                                    $total_bukan_sawah = ($value['bukan_panen'] - $value['bukan_panen_muda'] - $value['bukan_panen_ternak']) +  ($value['bukan_tanam'] -  $value['bukan_rusak']);
                                                    ...
                                                    <td <?= $status_bukan_sawah; ?>><?= $value['bukan_panen_muda']; ?></td>
                                                    <td <?= $status_bukan_sawah; ?>><?= $value['bukan_panen_ternak']; ?></td>
                                                    <td <?= $status_bukan_sawah; ?>><?= $value['bukan_tanam']; ?></td>
                                                    <td <?= $status_bukan_sawah; ?>><?= $value['bukan_rusak']; ?></td>
                                                    <td <?= $status_bukan_sawah; ?>><?= $total_bukan_sawah_sekarang; ?></td>
                                                </tr>
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                                            ...
                                            foreach ($user_palawija as $ut) { ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <?php if ($data_palawija->status != 'Complete') { ?>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('detail_palawija/delete_user/' . encrypt_url($ut['id']) . '/' . encrypt_url($id_data_palawija) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus">
                                                                <i class="icon-trash red-text"></i>
                                                            </a>
                                                        </td>
                            ...
                            <div class="card-footer white">
                                <?php if ($data_palawija->status != 'Complete') { ?>
                                    <a href="#modal-tambah-user" data-toggle="modal" class="btn btn-outline-primary btn-xs"><i class="icon-plus"></i> Add New Data</a>
                                <?php } ?>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            <div class="card-header white">
                                <a href="<?= base_url('data_palawija/filter/' . encrypt_url($id_bulan) . '/' . encrypt_url($id_provinsi) . '/' . encrypt_url($tahun)); ?>">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                ...
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('detail_palawija/add'); ?>" id="modalform">
                        ...
                        <div class="card">
                            <div class="card-body b-b">
                                ...
                                <div class="row pb-4">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" id="id_subkategori_palawija" name="id_subkategori_palawija" required>
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="row pb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" type="number" name="sawah_panen_muda" id="sawah_panen_muda" value="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="row pb-4">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control" type="number" name="sawah_panen_ternak" id="sawah_panen_ternak" value="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="row pb-4">
                                    <label class="col-md-3 col-form-label">Panen Muda</label>
                                    <div class="col-md-9">
                                        <input class="form-control" type="number" name="bukan_panen_muda" id="bukan_panen_muda" value="0" required>
                                    </div>
                                </div>
                                ...
                                <div class="row pb-4">
                                    <label class="col-md-3 col-form-label">Panen Ternak</label>
                                    <div class="col-md-9">
                                        <input class="form-control" type="number" name="bukan_panen_ternak" id="bukan_panen_ternak" value="0" required>
                                    </div>
                                </div>
    ...
    <div class="modal fade" id="modal-tambah-user" tabindex="-1" role="dialog" aria-labelledby="modalCreateMessage">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                <div class="modal-header r-0 bg-primary">
                    <h6 class="modal-title text-white" id="exampleModalLabel">Tambah Pemeriksan Data</h6>
                    <a href="#" data-dismiss="modal" aria-label="Close" class="paper-nav-toggle paper-nav-white active"><i></i></a>
                </div>
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('detail_palawija/add_user'); ?>" id="modalform">
                        <input type="hidden" name="id_data_palawija" value="<?= $id_data_palawija; ?>">
                        <input type="hidden" name="id_bulan" value="<?= $id_bulan; ?>">
                        <input type="hidden" name="id_provinsi" value="<?= $id_provinsi; ?>">
                        <input type="hidden" name="tahun" value="<?= $tahun; ?>">
    ...
    <div class="modal fade" id="modal-verifikasi" tabindex="-1" role="dialog" aria-labelledby="modalCreateMessage">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                ...
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('detail_palawija/complete'); ?>" id="modalform">
                        <input type="hidden" name="id_data_palawija" value="<?= $id_data_palawija; ?>">
                        <input type="hidden" name="id_bulan" value="<?= $id_bulan; ?>">
                        <input type="hidden" name="id_provinsi" value="<?= $id_provinsi; ?>">
                        <input type="hidden" name="tahun" value="<?= $tahun; ?>">
                        ...
                        <div class="card">
                            <div class="card-body b-b">
                                ...
                                <div class="row pb-4">
                                    <h3 style="color: red;text-align:center">Harap periksa data terlebih dahulu sebelum melakukaan penyelesaian data, karena data yang sudah dinyatakan selesai tidak bisa di edit kembali.</h3>
                                </div>
    ...
    <script>
        window.onload = function() {
            $("select[name='id_kategori_palawija']").click(function() {
                var url = "<?= base_url('detail_palawija/subkategori_palawija/'); ?>" + $(this).val();
                $("select[name='id_subkategori_palawija']").load(url);
                return false;
            });
            ...
            $("select[name='jenis_sawah']").click(function() {
                ...
                if (jenis_sawah == 'Sawah') {
                    ...
                    $("#bukan_panen_muda").attr('readonly', 'readonly');
                    $("#bukan_panen_ternak").attr('readonly', 'readonly');
                    $("#bukan_tanam").attr('readonly', 'readonly');
                    $("#bukan_rusak").attr('readonly', 'readonly');
                } else {
                    $("#bukan_panen").removeAttr('readonly');
                    $("#bukan_panen_muda").removeAttr('readonly');
                    $("#bukan_panen_ternak").removeAttr('readonly');
                ...
                if (jenis_sawah == 'Bukan') {
                    ...
                    $("#sawah_panen_muda").attr('readonly', 'readonly');
                    $("#sawah_panen_ternak").attr('readonly', 'readonly');
                    $("#sawah_tanam").attr('readonly', 'readonly');
                    $("#sawah_rusak").attr('readonly', 'readonly');
                } else {
                    $("#sawah_panen").removeAttr('readonly');
                    $("#sawah_panen_muda").removeAttr('readonly');
                    $("#sawah_panen_ternak").removeAttr('readonly');
