					...
					<div class="card my-3 no-b">
						<div class="card ">
							<div class="card-header white">
								...
								<strong> TABEL BULAN </strong>
							</div>
							<div class="card-body p-6 bg-light" data-height="100%">
								<div class="table-responsive">
									<table id="customer_data" class="table table-striped table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
										<thead>
											<tr>
										...
										<tbody>
											...
											foreach ($bulan as $value) { ?>
												<tr>
													...
													<td><?= $value['bulan']; ?></td>
													<td>
														<a href="<?= base_url('bulan/edit/' . encrypt_url($value['id'])); ?>" data-toggle="tooltip" data-placement="bottom" title="Edit">
															<i class="icon-edit green-text"></i>
														</a>
														&nbsp
														<a href="<?= base_url('bulan/delete/' . encrypt_url($value['id'])); ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus">
		...
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content b-0">
				...
				<div class="modal-body no-p no-b">
					<form role="form" method="post" action="<?= base_url('bulan/add'); ?>" id="modalform">
						<div class="card">
							<div class="card-body b-b">
								...
								<div class="row pb-4">
									...
									<div class="col-md-9">
										<input class="form-control" type="text" name="bulan" maxlength="100" required>
									</div>
								</div>
							</div>
