    ...
    <div class="container-fluid text-white">
        ...
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url(); ?>pengecekan">Pengecekan Data Palawija</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            ...
                            <form role="form" method="post" action="<?= base_url('pengecekan_palawija/filter'); ?>">
                                        ...
                                        <table id="customer_data" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            <thead class="thead-light">
                                                <tr>
                                                    ...
                                                    <th width="10%">Status Verifkasi</th>
                                                    <th width="10%">Aksi</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                ...
                                                foreach ($data_palawija as $value) { ?>
                                                    <tr>
                                                        <td><?= $no++; ?></td>
                                                        <td><?= $value['nomor']; ?></td>
                                                        <td><?= wilayah('provinsi', $value['id_provinsi']) . ', ' . wilayah('kecamatan', $value['id_kecamatan']) . ', ' . wilayah('kabupaten', $value['id_kabupaten']); ?></td>
                                                        <td><?= $value['nama_lengkap']; ?></td>
                                                        <td>
                                                            <?php
                                                            if ($value['status'] == 'Pending') {
                                                                echo '<span class="badge badge-warning">Tunggu</span>' . ' <br/>[ ' . date('d-m-Y | H:i:s', strtotime($value['update_at']))  . ' ]';
                                                            } else {
                                                                echo '<span class="badge badge-primary">Selesai</span>' . ' <br/>[ ' . date('d-m-Y | H:i:s', strtotime($value['update_at']))  . ' ]';
                                                            }
                                                            ?>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('pengecekan_palawija/detail/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Detail">
                                                                <i class="icon-input green-text"></i>
                                                            </a>
                                                            &nbsp;

                                                            <?php if ($value['status_verifikasi'] != 'Cancel') { ?>

                                                                <a href="<?= base_url('pengecekan_palawija/ditolak/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Ditolak">
                                                                    <i class="icon-ban red-text"></i>
                                                                </a>
