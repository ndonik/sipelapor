        ...
        <div class="row p-t-b-10 ">
            <div class="col">
                <h4>
                    ...
                    <b>PENGECEKAN DATA DETAIL PALAWIJA</b>
                </h4>
            </div>
        </div>
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('pengecekan_palawija/filter/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>">Pengecekan Data Palawija</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link">Pengecekan Data Detail Palawija</a>
                </li>
            </ul>
        </div>
    </div>
...
<div class="container-fluid relative animatedParent animateOnce">
            ...
            <div class="row my-3">
                            ...
                            <div class="card-body p-6 bg-light" data-height="100%">
                                <div class="row">
                                    ...
                                    <div class="col-5">
                                        ...
                                        <div class="row form-group">
                                            <label class="col-md-3 col-form-label">Verifikasi</label>
                                            <div class="col-md-9">
                                                <?php
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            ...
                            <div class="card-body p-6 bg-light" data-height="100%">
                                <table id="customer_data" class="table table-bordered table-hover dataTable js-exportable">
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            <div class="card-header white">
                                <a href="<?= base_url('pengecekan_palawija/filter/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>">
                                ...
                                <?php if ((@$user->id) && $user->status != 'Complete' && $data_palawija->status == 'Complete') { ?>
                                    ...
                                    <button href="#modal-cancel" data-toggle="modal" class="btn btn-sm btn-success">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                <div class="modal-header r-0 bg-primary">
                    <h6 class="modal-title text-white" id="exampleModalLabel">Verifikasi !</h6>
                    <a href="#" data-dismiss="modal" aria-label="Close" class="paper-nav-toggle paper-nav-white active"><i></i></a>
                </div>
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('pengecekan_palawija/verifikasi'); ?>" id="modalform">
                        <input type="hidden" name="id_data_palawija" value="<?= $id_data_palawija; ?>">
                        <input type="hidden" name="id_bulan" value="<?= $id_bulan; ?>">
                        <input type="hidden" name="tahun" value="<?= $tahun; ?>">
                        <input type="hidden" name="id_user_palawija" value="<?= $user->id; ?>">

                        <div class="card">
                            <div class="card-body b-b">
                                <div class="row pb-4">
                                    <label class="col-md-3 col-form-label">Keterangan/Catatan</label>
                                    <div class="col-md-9">
    ...
    <div class="modal fade" id="modal-cancel" tabindex="-1" role="dialog" aria-labelledby="modalCreateMessage">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                <div class="modal-header r-0 bg-danger">
                    <h6 class="modal-title text-white" id="exampleModalLabel">Data Dikoreksi !</h6>
                    <a href="#" data-dismiss="modal" aria-label="Close" class="paper-nav-toggle paper-nav-white active"><i></i></a>
                </div>
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('pengecekan_palawija/cancel'); ?>" id="modalform">
                        <input type="hidden" name="id_data_palawija" value="<?= $id_data_palawija; ?>">
                        <input type="hidden" name="id_bulan" value="<?= $id_bulan; ?>">
                        <input type="hidden" name="tahun" value="<?= $tahun; ?>">
                        <input type="hidden" name="id_user_palawija" value="<?= $user->id; ?>">
