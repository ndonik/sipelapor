    ...
    <div class="container-fluid text-white">
        ...
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url(); ?>kategori_padi">Kategori Padi</a>
                </li>
            </ul>
        </div>
    </div>
                    ...
                    <div class="card my-3 no-b">
                        <div class="card ">
                            <div class="card-header white">
                                ...
                                <strong> TABEL KATEGORI PADI </strong>
                            </div>
                            <div class="card-body p-6 bg-light" data-height="100%">
                                <div class="table-responsive">
                                    <table id="customer_data" class="table table-bordered" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                        ...
                                        <tbody>
                                            <?php $no = 1;
                                            foreach ($kategori_padi as $value) { ?>
                                                <tr>
                                                    <td><?= $no++; ?></td>
                                                    <td><?= $value['uraian']; ?></td>
                                                    <td>
                                                        <a href="<?= base_url('kategori_padi/edit/' . encrypt_url($value['id'])); ?>" data-placement="bottom" title="Edit">
                                                            <i class="icon-edit green-text"></i>
                                                        </a>
                                                        <a href="<?= base_url('kategori_padi/delete/' . encrypt_url($value['id'])); ?>" data-toggle="tooltip" data-placement="bottom" title="Hapus">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                ...
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('kategori_padi/add'); ?>" id="modalform">
                        <div class="card">
