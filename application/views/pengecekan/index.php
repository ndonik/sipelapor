    ...
    <div class="container-fluid text-white">
        ...
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url(); ?>pengecekan">Pengecekan Data Padi</a>
                </li>
            </ul>
        </div>
    </div>
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            ...
                            <form role="form" method="post" action="<?= base_url('pengecekan/filter'); ?>">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data_padi as $value) { ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="<?= base_url('pengecekan/detail/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Detail">
                                                            ...
                                                            <?php if ($value['status_verifikasi'] != 'Cancel') { ?>
                                                                ...
                                                                <a href="<?= base_url('pengecekan/ditolak/' . encrypt_url($value['id']) . '/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>" data-toggle="tooltip" data-placement="bottom" title="Ditolak">
