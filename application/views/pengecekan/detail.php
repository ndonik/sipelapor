        ...
        <div class="row p-t-b-10 ">
            <div class="col">
                <h4>
                    ...
                    <b>PENGECEKAN DATA DETAIL PADI</b>
                </h4>
            </div>
        </div>
        <div class="row ">
            <ul class="nav responsive-tab">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?= base_url('pengecekan/filter/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>">Pengecekan Data Padi</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link">Pengecekan Data Detail Padi</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            <div class="row my-3">
                        ...
                        <div class="card ">
                            ...
                            <div class="card-body p-6 bg-light" data-height="100%">
                                <div class="table-responsive">
                                    <table id="customer_data" class="table table-bordered dataTable js-exportable">
                ...
                <div class="col-md-12">
                    <div class="card my-3 no-b">
                        <div class="card ">
                            <div class="card-header white">
                                <a href="<?= base_url('pengecekan/filter/' . encrypt_url($id_bulan) . '/' . encrypt_url($tahun)); ?>">
                                ...
                                <?php if ((@$user->id) && $user->status != 'Complete' && $data_padi->status == 'Complete') { ?>
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                ...
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('pengecekan/verifikasi'); ?>" id="modalform">
                        <input type="hidden" name="id_data_padi" value="<?= $id_data_padi; ?>">
                        <input type="hidden" name="id_bulan" value="<?= $id_bulan; ?>">
                        <input type="hidden" name="tahun" value="<?= $tahun; ?>">
                        <input type="hidden" name="id_user_padi" value="<?= $user->id; ?>">
    ...
    <div class="modal fade" id="modal-cancel" tabindex="-1" role="dialog" aria-labelledby="modalCreateMessage">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content b-0">
                ...
                <div class="modal-body no-p no-b">
                    <form role="form" method="post" action="<?= base_url('pengecekan/cancel'); ?>" id="modalform">
                        <input type="hidden" name="id_data_padi" value="<?= $id_data_padi; ?>">
                        <input type="hidden" name="id_bulan" value="<?= $id_bulan; ?>">
                        <input type="hidden" name="tahun" value="<?= $tahun; ?>">
                        <input type="hidden" name="id_user_padi" value="<?= $user->id; ?>">
